  ...
  return (
    <div className='recipe-container'>
        <div className='img-text-container'>
            <div className="main-recipe-image-container">
                <img src={imgSrc} alt="Sirnik"/>
            </div>
        ...
        <p className="description-text" style={{marginTop: '8px'}}>Ингредиенты: {ingredients.join(', ')}</p>
    </div>
  )
}
